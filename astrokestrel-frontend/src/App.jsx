  ...
  if (flight) {
    return (
      <div onClick={onClick} style={{ background: selected ? "#001a0a" : "#000d0d", border: `1px solid ${selected ? "#00ff88" : "#00ff8830"}`, borderRadius: "4px", padding: "1rem", cursor: "pointer", marginBottom: "8px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: "10px", paddingTop: "8px", borderTop: "1px solid #00ff8820" }}>
...
function FloatingChat({ dashboardData, flight }) {
  ...
  return (
    <>
      {open && (
        <div style={{ position: "fixed", bottom: "90px", right: "24px", width: "360px", height: "480px", background: bg, border: `1px solid ${border}`, borderRadius: flight ? "4px" : "16px", display: "flex", flexDirection: "column", zIndex: 1000, boxShadow: `0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px ${border}` }}>
          <div style={{ padding: "14px 16px", borderBottom: `1px solid ${border}`, display: "flex", justifyContent: "space-between", alignItems: "center", background: flight ? "#001a0a" : "rgba(99,102,241,0.08)", borderRadius: flight ? "4px 4px 0 0" : "16px 16px 0 0" }}>
            <div>
              ...
              <div style={{ fontSize: "10px", color: flight ? "#00aa55" : "#64748b", marginTop: "2px", fontFamily: ff }}>{flight ? "BIOTELEMETRY INTELLIGENCE INTERFACE" : "Powered by real NASA biomarker data"}</div>
            </div>
            <button onClick={() => setOpen(false)} style={{ background: "transparent", border: "none", color: flight ? "#00aa55" : "#64748b", fontSize: "20px", cursor: "pointer", lineHeight: 1 }}>×</button>
          </div>
      ...
      <button onClick={() => setOpen(!open)} style={{ position: "fixed", bottom: "24px", right: "24px", width: "56px", height: "56px", borderRadius: "50%", background: flight ? "#001a0a" : accent, border: `2px solid ${accent}`, color: flight ? accent : "white", fontSize: "22px", cursor: "pointer", zIndex: 1001, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `0 4px 20px ${accent}40`, transition: "all 0.2s" }}>
        {open ? "×" : "🦅"}
      </button>
    </>
  )
